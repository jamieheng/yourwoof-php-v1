    ...
    <div class="invoice_table">
      <div class="i_table">
        <div class="i_table_head">
          <div class="i_row">
            <div class="i_col w_50 text_center">
              <p colspan="5" class="p_title">Pet name</p>
            </div>
            <div class="i_col w_50 text_center">
              <p class="p_title">Pet breed</p>
            </div>
            
            <div class="i_col w_50 text_center">
              <p class="p_title">Pet Gender</p>
            </div>
            <div class="i_col w_50 text_center">
              <p class="p_title">Vaccinated</p>
            </div>
